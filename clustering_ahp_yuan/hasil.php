    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-white">Data Pembagian Kelas Karyawan Magang</h1>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-success">Data Pembagian Kelas Karyawan Magang
                                &emsp;
                                <button class="btn btn-outline-success" data-toggle="modal" data-target="#cetak"><i
                                        class="fas fa-print"></i></button>
                            </h6>
                        </div>
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
                                <li class="nav-item "><a class="nav-link show active" href="#solid-rounded-justified-a"
                                        data-toggle="tab">Kelas A
                                <li class="nav-item"><a class="nav-link" href="#solid-rounded-justified-b"
                                        data-toggle="tab">Kelas B
                                <li class="nav-item"><a class="nav-link" href="#solid-rounded-justified-c"
                                        data-toggle="tab">Kelas C
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane show active" id="solid-rounded-justified-a">
                                    <div class="table-responsive">
                                        <center>
                                            <h3>Data Karyawan Magang Kelas A</h3>
                                        </center>
                                ...
                                <div class="tab-pane" id="solid-rounded-justified-b">
                                    <div class="table-responsive">
                                        <center>
                                            <h3>Data Karyawan Magang Kelas B</h3>
                                        </center>
                                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                ...
                                <div class="tab-pane" id="solid-rounded-justified-c">
                                    <div class="table-responsive">
                                        <center>
                                            <h3>Data Karyawan Magang Kelas C</h3>
                                        </center>
                                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
