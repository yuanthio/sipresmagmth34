...
<body id="page-top">
    ...
    <!-- Page Wrapper -->
    <div id="wrapper" style="background-color: rgb(13, 10, 44);">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        Karyawan Magang</div>
                                    <?php
                                    $queryCountSantri = "SELECT COUNT(*) AS totalSantri FROM tb_santri_2";
                                    $resultCountSantri = $koneksi->query($queryCountSantri);

                                    if ($resultCountSantri) {
                                        $rowSantri = $resultCountSantri->fetch_assoc();
                                        $totalSantri = $rowSantri['totalSantri'];
                                    } else {
                                        $totalSantri = 0;
                                    }
                                    ?>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <?php echo $totalSantri; ?>
                                    </div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        Kriteria</div>
                                    <?php
                                    $queryCountKriteria = "SELECT COUNT(*) AS totalKriteria FROM tb_kriteria";
                                    $resultCountKriteria = $koneksi->query($queryCountKriteria);

                                    if ($resultCountKriteria) {
                                        $rowKriteria = $resultCountKriteria->fetch_assoc();
                                        $totalKriteria = $rowKriteria['totalKriteria'];
                                    } else {
                                        $totalKriteria = 0;
                                    }
                                    ?>
                ...
                <!-- Earnings (Monthly) Card Example -->
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card profile shadow h-100 py-2" style="background-color: rgb(24, 18, 92);">
                        <div class="card-body">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-uppercase mb-1"
                                            ...
                                            Yuanthio Virly </div>
                                        <div class="h5 mb-0 font-weight-bold" style="color: aliceblue;">065120038</div>
                                    </div>
                                    <div class="col-auto">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <a class="small" href="#" data-toggle="modal" data-target="#loginmodal"
                            data-dismiss="modal">Already have an account? Login!</a>
                    </div>
