    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-white">Data Kriteria</h1>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-success">Kriteria
                                &emsp;
                                    ...
                                    <tbody>
                                        ...
                                        while ($data = $ambil->fetch_array()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $data['jenis_kriteria']; ?>
                                                </td>
                                                <td>
                                                    <button data-toggle="modal"
                                                        data-target="#edit<?php echo $data['id_kriteria']; ?>"
                                                        class="btn btn-outline-warning"><i class="fas fa-edit"></i></button>
                                                    <button data-toggle="modal"
                                                        data-target="#delete<?php $data['id_kriteria']; ?>"
                                                        class="btn btn-outline-danger"><i class="fas fa-trash"></i></button>
                                                </td>
                                            </tr>
                                            <!-- Edit Modal-->
                                            <div class="modal fade" id="edit<?php echo $data['id_kriteria']; ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="user" method="post"
                                                                action="edit_kriteria.php?id=<?php echo $data['id_kriteria']; ?>">
...
if (isset($_POST['add'])) {
    ...
    $koneksi->query("INSERT INTO tb_kriteria
        (jenis_kriteria) 
        VALUES ('$_POST[nama]')");  // Tambahkan tanda kurung penutup di sini
