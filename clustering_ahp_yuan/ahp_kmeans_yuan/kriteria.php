...
if (isset($_POST['delete'])) {
	$id = $_POST['id'];
	if (deleteKriteria($id)) {
		$deleteSuccessMessage = 'Berhasil delete kriteria';
	} else {
		$deleteErrorMessage = 'Berhasil delete kriteria';
	}
}
...
<section class="content" style="background-color: rgb(13, 10, 44)">
	<h2 class="ui header text-white">Kriteria</h2>
	<?php
