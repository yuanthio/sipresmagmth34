...
<section class="content" style="background-color: rgb(13, 10, 44)">
	<h2 class="ui header text-white">Hasil Perhitungan</h2>
	...
	<h2 class="ui header text-white">Perangkingan</h2>
			...
			while ($row = mysqli_fetch_array($result)) {
				...
				<tr>
					...
					<td style="font-size: 1.1em;">
						...
						$status = ($hasil == 'A' || $hasil == 'B' || $hasil == 'C') ? '<span class="badge text-bg-success">Diperpanjang</span>' : '<span class="badge text-bg-danger">Tidak Diperpanjang</span>';
						echo $status;
						?>
					</td>
				</tr>
